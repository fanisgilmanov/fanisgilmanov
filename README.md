## Всем привет, меня зовут Фанис

### Немного о себе:

 - :technologist: В 2019 году начал работать ручным тестировщиком
 - :astronaut: C 2022 года изучаю и занимаюсь автоматизацией тестирования
